...
class MemoryWindowAttention(nn.Module):
    """
    This code is the Swin Transformer carrying the memory-attention, written by Guorun Li.
    """
    def __init__(self, dim, window_size, num_heads, qkv_bias=True, qk_scale=None, attn_drop=0., proj_drop=0.):
    ...
    def forward(self, x, mask=None, pos_embed=None, memory=None):
        '''
...
class MemorySwinTransformerBlock(nn.Module):
    ...
    def forward(self, x, mask_matrix, memory):
        ...
        # W-MSA/SW-MSA
        attn_windows, memory = self.attn(x_windows, mask=attn_mask, pos_embed=None, memory=memory)
...
class BasicLayer(nn.Module):
    ...
    def forward(self, x, S, H, W):
        ...
        for blk in self.blocks:
            ...
            x, memory = blk(x, attn_mask, memory)
...
class Encoder(nn.Module):
    """
    This code is the nnFormer Encoder carrying the Memory-Attention and ISTS, written by Guorun Li.
    """
    def __init__(self,
...
class MemorynnFormer(SegmentationNetwork):
    """
    MemorynnFormer based on : Guorun Li
    The code for MemorynnFormer is based on the nnFormer.
    """
    def __init__(self, crop_size=[96,96,96],
        ...
        super(MemorynnFormer, self).__init__()
