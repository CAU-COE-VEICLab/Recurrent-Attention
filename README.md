# Memory-Attention
This is the code base for **`"Making your visual deep neural networks remember more information"`**, and the article is submitted to **`International Journal of Computer Vision`**.
