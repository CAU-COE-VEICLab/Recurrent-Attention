...
parser.add_argument('--network', type=str, default='MemorySwinUNETR', help='Network models: {MemorySwinUNETR, MemorynnFormer, TransBTS, nnFormer, UNETR, SwinUNETR, 3DUXNET}')
