...
class WindowRecurrentAttention(nn.Module):
    """
    This code is the Swin Transformer carrying the recurrent-attention, written by Guorun Li.
    """
    def __init__(self, dim, window_size, num_heads, qkv_bias=True, qk_scale=None, attn_drop=0., proj_drop=0.):
    ...
    def forward(self, x, mask=None, pos_embed=None, memory=None):
        ...
        q: The parameter q represents the Q_hat.
        '''
...
class Encoder(nn.Module):
    """
    This code is the nnFormer Encoder carrying the Recurrent-Attention-H, written by Guorun Li.
    """
    def __init__(self,
...
class nnFormerRecA(SegmentationNetwork):
    """
    nnFormer-RecA based on : Guorun Li
    The code for nnFormer-RecA is based on the nnFormer.
    """
    def __init__(self, crop_size=[96,96,96],
        ...
        super(nnFormerRecA, self).__init__()
